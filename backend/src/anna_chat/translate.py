...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "- Tables → render as GitHub-flavored markdown with a header row and a "
    "separator row (e.g. `| Col A | Col B |\\n|---|---|\\n| value 1 | value 2 |`). "
    "If the source already contains a markdown table, preserve its structure "
    "and only translate the cell contents.\n"
